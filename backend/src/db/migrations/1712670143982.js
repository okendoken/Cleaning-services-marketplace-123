module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('reviews', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('orders', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('vendors', 'userId', { transaction });

      await queryInterface.removeColumn('vendors', 'hourly_rate', {
        transaction,
      });

      await queryInterface.removeColumn('reviews', 'vendorId', { transaction });
      ...
      await queryInterface.removeColumn('orders', 'vendorId', { transaction });
