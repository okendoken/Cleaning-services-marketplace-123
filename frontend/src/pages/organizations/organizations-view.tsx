    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Orders organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.orders_organization &&
                      Array.isArray(organizations.orders_organization) &&
                      organizations.orders_organization.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!organizations?.orders_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Reviews organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.reviews_organization &&
                      Array.isArray(organizations.reviews_organization) &&
                      organizations.reviews_organization.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!organizations?.reviews_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
