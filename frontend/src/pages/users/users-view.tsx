            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.reviews_customer &&
                      Array.isArray(users.reviews_customer) &&
                      users.reviews_customer.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.vendors_user &&
                      Array.isArray(users.vendors_user) &&
                      users.vendors_user.map((item: any) => (
                        ...
                        >
                          <td data-label='hourly_rate'>{item.hourly_rate}</td>
